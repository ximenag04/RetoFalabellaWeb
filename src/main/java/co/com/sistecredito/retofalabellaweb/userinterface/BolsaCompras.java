...
public class BolsaCompras {
    ...
    public static final Target SELECCIONARPRODUCTO = Target.the("seleccionar el producto encontrado").located(By.xpath("(//div[@id=\"testId-searchResults-products\"]/div[1]/div//button)[2]"));
