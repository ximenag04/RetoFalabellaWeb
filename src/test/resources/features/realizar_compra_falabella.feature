Feature: realizar la compra de un producto en la pagina oficial de Falabella
  ...
  Scenario: realizar compra de producto
    ...
    When requiere comprar un producto
      | busqueda | cantidad | departamento | ciudad   | barrio   | direccion | complemento | numtarjeta        | numdocumento |
      | Xiomi    | 2        | ANTIOQUIA    | MEDELLIN | MEDELLIN | Cra 72 80 | Apto 1902   | 44567812309175413 | 1152464708   |
